...
#Net
      ...
      strenght="^fg(xfg)$strenght^fg($xext)%"
...
###############################################
#Panel
        right="$separator ^fg ^fg()^i(/usr/share/icons/stlarch_icons/arch1.xbm)$rchico^fg() $separator^fg() $date $separator^fg() ^i(/usr/share/icons/stlarch_icons/logout1.xbm) $uptime $separator^fg() ^i(/usr/share/icons/stlarch_icons/mem1.xbm) $mem $separator^fg() ^i(/usr/share/icons/stlarch_icons/vol1.xbm) $volm $separator^fg() ^i(/usr/share/icons/stlarch_icons/wireless1.xbm) $strenght $separator $separator^fg() ^fg "
